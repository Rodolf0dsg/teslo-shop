  ...
  return (
    <div className={"flex flex-col gap-6"}>
          ...
          <form className="p-6 md:p-8" onSubmit={ (e) => handleRegister(e) }>
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                ...
                <Input id="fullName" type="text" name="name" placeholder="Ingrese su nombre" required />
              </div>
      ...
      <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
        Haciendo click estas de acuerdo con nuestros <a href="#">Terminos de servicio</a> y <a href="#">Politica de privacidad</a>.
      </div>
    </div>
  )
}
