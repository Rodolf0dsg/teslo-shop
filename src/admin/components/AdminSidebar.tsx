...
export const AdminSidebar: React.FC<SidebarProps> = ({ isCollapsed, onToggle }) => {
  ...
  return (
    <div className={`bg-white border-r border-gray-200 transition-all duration-300 ease-in-out h-17 ${
      isCollapsed ? 'w-19' : 'w-64'
    } flex flex-col`}>
      {/* Header */}
      <div className="p-4 border-b border-gray-200 flex items-center justify-between h-17">
        {!isCollapsed && (
          <CustomLogo />
        )}
        <button
